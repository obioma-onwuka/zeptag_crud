<div class="row">
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="first_name" id="first_name" class="form-control @error('first_name') is-invalid @enderror" value = "{{old('first_name', $contact->first_name)}}" autofocus>
        ...
        <div class="form-group row mb-0">
            <div class="col-md-9 offset-md-3">
                ...
                <a href="{{$contact->exists ? route('contacts.show', ['contact' => $contact->id]) : route('contacts.index')}}" class="btn btn-outline-secondary">{{$contact->exists ? "Back" : "All Contacts"}}</a>
            </div>
        </div>
    </div>
</div>